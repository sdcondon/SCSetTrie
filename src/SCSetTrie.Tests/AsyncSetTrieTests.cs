...
namespace SCSetTrie.Tests
{
    public static class AsyncSetTrieTests
    {
        public static Test GetSubsetsBehaviour => TestThat
            ...
            .When(tc =>
            {
                var sut = new AsyncSetTrie<int>(new CollisionResolvingHashCodeComparer<int>(), new AsyncSetTrieDictionaryNode<int, ISet<int>>(), tc.Content.Select(a => new HashSet<int>(a)));
